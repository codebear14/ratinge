...
<body>
    ...
    <div class="movieList">
        <h2 style="color: #575756">Top 25 Box Office Movies</h2>
        <%
            MySQLDb db = MySQLDb.createInstance();
            String qFetchBoxMovies = "SELECT * FROM ratinge.movies WHERE gross_income > 0 ORDER BY gross_income DESC LIMIT 25";
            List<Movie> movies = db.getMovies(qFetchBoxMovies);
            pageContext.setAttribute("listOfBoxOfficeMovies", movies);
        %>
        <c:forEach items="${listOfBoxOfficeMovies}" var="movie">
            <div class="movie">
                <hr/>
                <h3>
                    ${movie.getTitle()}
